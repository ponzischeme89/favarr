...
Multi‑server favourites concierge for Emby, Jellyfin, Plex and Audiobookshelf. Add or tidy favourites for any user without jumping between apps or asking them to log in.
